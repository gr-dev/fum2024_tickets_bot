...
При регистрации на самом мероприятии назови администратору на ресепшене соответствующий код и имя, на которое был оформлен заказ."""
        ...
        self.awaitingPayment = """Сделай перевод по [ссылке Тинькофф](https://www\.tinkoff\.ru/cf/6JHd9O4JEM7) или c помощью СБП по номеру [\+79149279685](tel:\+79149279685) на *Тинькофф Банк* \(получатель Кирилл Х\.\) и отправь *в данный чат* чек/квитанцию"""
